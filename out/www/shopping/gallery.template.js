...
export default class JSNode {
    constructor(data, existingNode) {
        ...
        this.funcs = { loopItemCartcart_1(self, docElm, elm, items) {
          ...
          `));
            ...
            ifItemInStock_3(self, docElm, elm) {
                const fn = function () {
                    elm.appendChild(docElm.createTextNode(`
          `));
                    elm.appendChild((function () {
        ...
        `));
            ...
            loopItemItemsitems_2(self, docElm, elm, items) {
                const fn = function () {
                    elm.appendChild(docElm.createTextNode(`
    `));
                    elm.appendChild((function () {
      ...
      `));
                        {
                            let tmpElm = self._getPrecedingOrSelf(elm), tmpCss = tmpElm.getAttribute('class') || '', target = tmpCss.length ? tmpCss.split(/s/) : [];
  ...
  `));
            elm.appendChild((function () {
                const elm = docElm.createElement('section');
    ...
    `));
                elm.appendChild((function () {
                    ...
                    elm.appendChild((function () {
                        const elm = docElm.createElement('sub');
  ...
  `));
    ...
    `));
      ...
      `));
        ...
        `));
                                elm.appendChild((function () {
                                    const elm = docElm.createElement('tfoot');
                                    elm.appendChild(docElm.createTextNode(`
          `));
                                    elm.appendChild((function () {
                                        const elm = docElm.createElement('tr');
...
//# sourceMappingURL=gallery.template.js.map