...
export default class JSNode {
  ...
  private fillNode(): ChildNode {
    ...
    this.node = (function () { const elm = docElm.createDocumentFragment();
elm.appendChild((function () { const elm = docElm.createElement('form');
...
function loopMovieMoviesMovies (self:JSNode, docElm:Document, elm:Node, items:any) {
          const fn = function() {
            elm.appendChild(docElm.createTextNode(`
    `));
...
elm.appendChild(docElm.createTextNode(`
    `));
elm.appendChild((function () { const elm = docElm.createElement('time');
