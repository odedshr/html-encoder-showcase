...
export default class JSNode {
    constructor(data, existingNode) {
        this.set = {};
        this.funcs = { ifItemInStock_1(self, docElm, elm) {
                const fn = function () {
      ...
      `));
                    elm.appendChild((function () {
                        ...
                        elm.setAttribute('class', 'product_action product_addBasket');
                        {
                            ...
                            node.setAttribute('data-add', self._getValue(self.data, 'item.id'));
                        }
                        elm.appendChild((function () {
    ...
    `));
                {
                    ...
                    const fn = self.funcs.ifItemInStock_1.bind({}, self, docElm, elm);
